...
define_keymap(re.compile("Firefox|Google-chrome|LibreWolf|Chromium|discord"), {
    ...
    K("C-o"): [K("C-a"), K("C-c"), launch(["nvim"]), sleep(0.5), K("C-v")]
}, "Firefox and Chrome")
...
define_keymap(lambda wm_class: wm_class not in ("Emacs", "URxvt", "konsole"), {
    ...
    # Kill line
    K("C-Shift-k"): [K("Shift-end"), K("C-x"), set_mark(False)],
    # Undo
